...
public class MulticastShoutcastClient extends ShoutcastClient {
    ...
    protected void streamSong(String filePath, int musicId) throws IOException, SQLException {
        // Open the file
        FileInputStream fin;
        try {
            ...
            // File wasn't found on disk, log a warning and then return
            // so the next song is chosen.
            Logger.log("WARNING", "File " + filePath + " not found on disk, skipping.");
            return;
        }
