...
public class MulticastShoutcastServer {
    ...
    public void runApp() throws IOException {
        ...
        while(true) {
            ...
            // Got a client, create a queue, start the packet listner and
            // kick off the streamer
            SimpleQueue q = new SimpleQueue();
            MulticastPacketListener mpl = new MulticastPacketListener(q);
            QueueShoutcastServerStreamer qsss = new QueueShoutcastServerStreamer(q, client);
            
            
            // Configure the source we're listening to
            mpl.setSource(SOURCE_NAME);
            
            // Tell it what multicast group to join
            mpl.setMulticastDetails(MCAST_ADDRESS, MCAST_PORT, TTL);
