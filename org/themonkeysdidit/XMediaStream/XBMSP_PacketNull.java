...
******************************************************************************
**
** A simple class to represent a null packet according to the XBMSP protocol.
**
...
******************************************************************************
*/
public class XBMSP_PacketNull extends XBMSP_BasePacket {
    public XBMSP_PacketNull() {
    }
    
    public XBMSP_PacketNull(byte[] rawData) {
        super(rawData);
    }
