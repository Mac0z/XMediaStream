...
******************************************************************************
**
** A simple class to represent a file_open packet according to the XBMSP protocol.
**
...
******************************************************************************
*/
public class XBMSP_PacketFileOpen extends XBMSP_BasePacket {
    public XBMSP_PacketFileOpen() {
    }
  
    public XBMSP_PacketFileOpen(byte[] rawData) {
        super(rawData);
